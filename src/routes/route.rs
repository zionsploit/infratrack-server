...
use crate::{enums::response_enum::{ResponseErrorMessage, VerifiedToken}, services::storage_service::{serve_image, storage}, utils::token::verified_token};
...
pub fn api_routes () -> Router {
    ...
    Router::new()
        ...
        .route("/image/{image_name}", get(serve_image))
}